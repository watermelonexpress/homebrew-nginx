...
Once the tap is installed, you can install `nginx-full`
    ...
    brew tap watermelonexpress/nginx
...
## Contributing
Please see the [contributing guide](https://github.com/watermelonexpress/homebrew-nginx/blob/master/.github/CONTRIBUTING.md).
